defmodule AncestryEcto.DescendantTest do
  use AncestryEcto.Case, async: true

  alias AncestryEcto.{Page, Descendant}
  ...
  describe "w/ default option" do
    test "ids/2", %{
      ...
      assert Descendant.ids(page4, options) == []
      assert Descendant.ids(page1, options) == [page2.id, page3.id, page4.id, page6.id]
    end
    ...
    test "list/2", %{
      ...
      assert [] = Descendant.list(page4, options)
  ...
  describe "w/ custom ancestry column and custom attribute column" do
    ...
    test "ids/2", %{
      ...
      assert Descendant.ids(page1, options) == [
               page2.reference,
               page3.reference,
               page4.reference,
               page6.reference
